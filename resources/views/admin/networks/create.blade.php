            ...
            <form method="post" action="{{ route('network.store') }}">
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 ">
                        <input type="text" name="networkID" required="required" class="form-control">
                    </div>
                </div>
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 ">
                        <input type="text" name="network" required="required" class="form-control">
                    </div>
                </div>
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 ">
                        <input type="text" name="urlpath" class="form-control">
                    </div>
                </div>
                <div class="item form-group">
