...
<html lang="en">
  <head>
    ...
    <!-- JQVMap -->
    <link href="{{ asset('backend/assets/vendors/jqvmap/dist/jqvmap.min.css')}}" rel="stylesheet"/>
  ...
  <body class="nav-md">
    ...
    <!-- JQVMap -->
    <script src="{{ asset('backend/assets/vendors/jqvmap/dist/jquery.vmap.js')}}"></script>
